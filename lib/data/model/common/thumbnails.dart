...
import 'package:flutter_youtube_search_bloc/data/model/common/thumbnail.dart';
import 'package:flutter_youtube_search_bloc/data/model/serializer/serializers.dart';

part 'thumbnails.g.dart';

abstract class Thumbnails implements Built<Thumbnails, ThumbnailsBuilder> {

  // because default is dart keyword
